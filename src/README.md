...
- `burst_oscillation_accretion_mapper.burst_detection`: Poisson excess bin scoring, grouping of adjacent interval candidates, and binned morphology summaries for later review.
