...
- Configurable Poisson excess scoring, conservative interval grouping, binned morphology review, and multi-cadence candidate clustering on synthetic light curves.
